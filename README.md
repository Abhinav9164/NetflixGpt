...
**NetflixGPT** is a web application that leverages the power of OpenAI's GPT-3.5 to enhance your Netflix experience. With this project, you can generate personalized movie and TV show recommendations based on your preferences, engage in natural language conversations to discover new content, and favorite shows by gpt-search.
...
- **MultiLinguial:** Added the feature where user can interact with website in 3 languages.

- **OpenAI API Integration:** Obtained an API key for OpenAI and integrated GPT for search functionality.

- **Redux Store with movieSlice:** State management for movie data is handled through Redux.
